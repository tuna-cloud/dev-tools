package com.tuna.tools.fiddler.tls.jdk;
...
public class CertificateSigningRequest {
     ...
     */
    public static final Date NOT_AFTER = new Date(System.currentTimeMillis() + 86400000L * 360);
    // distinguishing name
    public static final String ROOT_COMMON_NAME = "www.tuna.com";
    public static final String ORGANISATION = "Tuna";
    public static final String LOCALITY = "Beijing";
